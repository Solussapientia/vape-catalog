...
const vapeProducts = [
  {
    id: 'adjust',
    name: 'Adjust by Lost Mary',
    puffs: '40,000',
    price: '$25.00',
    imageName: 'ADJUST',
    flavors: [
      { name: 'Tigers blood', inStock: true },
      { name: 'Sour pinkberry', inStock: true },
      { name: 'Wintergreen savers', inStock: true },
      { name: 'Watermelon mango peach', inStock: true },
      { name: 'Sour island', inStock: true },
      { name: 'Blue raz ice', inStock: true },
      { name: 'Watermelon roll ups', inStock: true },
      { name: 'Baja splash', inStock: true },
      { name: 'Raspberry orange', inStock: true },
      { name: 'Lemon heads', inStock: true },
      { name: 'Sour lush gummy', inStock: true },
      { name: 'Dragon strawberry banana', inStock: true },
      { name: 'Raspberry watermelon', inStock: true },
      { name: 'Triple berry grape', inStock: true },
      { name: 'Pineapple ice peach', inStock: true },
      { name: 'Watermelon b-pop', inStock: true },
      { name: 'Triple berry', inStock: true },
      { name: 'Cherry fuse', inStock: true },
      { name: 'Strawberry mint candy', inStock: true },
      { name: 'Mixed mint', inStock: true },
      { name: 'Orange strawberry', inStock: true },
